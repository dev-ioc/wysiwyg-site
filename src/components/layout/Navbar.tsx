...
const Navbar = () => {
  ...
  return (
    <section id="accueil">
      <div className="relative grid grid-cols-12 col-span-12 h-auto lg:h-[761px] min-h-[480px] w-full border-b border-light bg-[url('/images/bg.png')] bg-cover bg-center bg-no-repeat overflow-hidden">
        <div className="hidden lg:flex col-span-12 h-[150px] justify-between items-center bg-white/40 px-4 py-3 gap-4">
        ...
        <div className="col-span-12 lg:col-start-5 flex flex-col items-center justify-center text-center gap-4 px-6 py-10 text-white relative z-10 pt-28 lg:pt-0 lg:-top-40 w-full lg:w-[583px]">
          <span className="text-[36px] lg:text-[53px] font-bold font-merriweather">
            WYSIWYG
          </span>
          <span className="max-w-[500px] text-[16px] lg:text-[20px] text-center text-secondary font-assistant font-bold">
